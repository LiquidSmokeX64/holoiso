...
base_os_install() {
	...
	cp -r /etc/holoinstall/post_install/beta_pacman.conf ${HOLO_INSTALL_DIR}/etc/beta_pacman.conf
	cp -r /etc/holoinstall/post_install/mirrorlist ${HOLO_INSTALL_DIR}/etc/pacman.d/mirrorlist
	cp -r /etc/holoinstall/post_install/holoiso-branch ${HOLO_INSTALL_DIR}/etc/holoiso-branch
	...
	rm ${HOLO_INSTALL_DIR}/etc/pacman.conf.old
